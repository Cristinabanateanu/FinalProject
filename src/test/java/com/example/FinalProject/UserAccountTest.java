...
public class UserAccountTest {
    ...
    public void testCreatedAddUserAccount(){
        AddNewUsersAccountRequest addNewUsersAccountRequest=new AddNewUsersAccountRequest();
        ...
        when(usersAccountMapper.fromUsersAccountEntity(any())).thenReturn(usersAccountResponse);
