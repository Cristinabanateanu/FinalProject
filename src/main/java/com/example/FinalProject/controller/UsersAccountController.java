...
public class UsersAccountController {
    ...
    @PostMapping()
    public ResponseEntity<UsersAccountResponse> addNewUsersAccount(@RequestBody @Valid AddNewUsersAccountRequest addNewUsersAccountRequest) {
        UsersAccountResponse responseBody = usersAccountService.addNewUserAccount(addNewUsersAccountRequest);
    ...
    @PostMapping("/add_to_watchlist/{id}")
