...
public class AuthService {
    ...
    public void registerUser(AddNewUsersAccountRequest addNewUsersAccountRequest) {

        UsersAccount usersAccount = usersAccountMapper.fromUsersAccountRequest(addNewUsersAccountRequest);
        Optional<AccountType> optionalAccountType = accountTypeRepository
                .findAccountTypeByName(addNewUsersAccountRequest.getAccountType());
        ...
        {
            throw new TypeNotFoundException("Type with name "+addNewUsersAccountRequest.getAccountName()+" is not in the db");
        }
    ...
    public SignInResponse signIn(SignInRequest signInRequest)
    {
        ...
        return usersAccountMapper.fromUsersAccountDetailsImpl(userDetails);
    }
